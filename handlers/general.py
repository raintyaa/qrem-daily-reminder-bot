...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    pesan = (
        ...
        "• `/tambahrutinitas [Hari] | [Jam] | [Keterangan]` - Tambah rutinitas (bisa multi-hari, contoh: `senin, kamis`)\n"
        "• `/hapusrutinitas [ID] [Hari (opsional)]` - Hapus rutinitas (semua hari atau hari tertentu)\n"
